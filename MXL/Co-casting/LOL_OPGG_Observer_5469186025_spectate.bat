...
set RADS_PATH="D:\Riot Games\League of Legends"
...
if exist "%RADS_PATH%\Game" (
	...
	if exist "League of Legends.exe" (
		@start "" "League of Legends.exe" "spectator spectator.euw1.lol.riotgames.com:80 AvprT/HywPPsAjEoXyP1dV5jRqW9ekdH 5469186025 EUW1" "-UseRads" "-Locale=!locale!" "-GameBaseDir=.."
		goto :eof
	)
)
